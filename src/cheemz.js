...
import './App.css';
import cheemzData from './cheemzData';
function Cheemz() {
  const [meme, setMeme] = React.useState({
    topText: "",
    bottomText: "",
    randomImage: "https://i.pinimg.com/236x/7a/51/a1/7a51a1c7a492824fe7167a38789d6a35.jpg"
  });
  const [allMemeImage, setAllMemeImage] = React.useState(cheemzData.data.memes);
