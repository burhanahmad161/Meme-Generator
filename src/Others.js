...
import './App.css';
import otherCartoons from './otherCartoons';
function Others() {
  const [meme, setMeme] = React.useState({
    topText: "",
    bottomText: "",
    randomImage: "https://i.pinimg.com/236x/19/f8/bb/19f8bb139d899437a38c902b26ac2827.jpg"
  });
  const [allMemeImage, setAllMemeImage] = React.useState(otherCartoons.data.memes);
