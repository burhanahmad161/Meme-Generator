...
import './App.css';
import tomJerry from './tomJerry';
function Tom() {
  const [meme, setMeme] = React.useState({
    topText: "",
    bottomText: "",
    randomImage: "https://i.pinimg.com/236x/85/3b/74/853b74c992281e7e69536ef829dccf5a.jpg"
  });
  const [allMemeImage, setAllMemeImage] = React.useState(tomJerry.data.memes);
